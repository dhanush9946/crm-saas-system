    ...
    public partial class AddPasswordResetTokens : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordResetTokens_TenantId_UserId_ExpiresAtUtc",
                table: "PasswordResetTokens",
                columns: new[] { "TenantId", "UserId", "ExpiresAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_PasswordResetTokens_TenantId_UserId_UsedAtUtc_RevokedAtUtc",
                table: "PasswordResetTokens",
                columns: new[] { "TenantId", "UserId", "UsedAtUtc", "RevokedAtUtc" });
